<%-- 
    ...
    Created on : Apr 23, 2014, 11:52:11 AM
    Author     : KhoaNN
--%>
    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Update product</h1></div>
                            ...
                            <div id="content-table-inner">
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            <!-- start id-form -->
                                            <form action="../ProductServlet?action=updateProduct&pId=${param.pId}" method="POST">
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <c:forEach var="product" items="${mrBean.getProductById(param.pId)}">
                                                        <tr>
                                                            <th valign="top">Product name:</th>
                                                            <td><input type="text" class="inp-form" name="txtProductName" value="${product.name}" /></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>	
                                                                <select class="styledselect_form_1" name="txtCategory" >
                                                                    <c:forEach var="p" items="${mrBean.category}">
                                                                        <c:choose>
                                                                        <c:when test="${product.categoryID == p.categoryID}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="inp-form" name="txtPrice" value="${product.price}" /></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">Quantity:</th>
                                                            <td><input type="text" class="inp-form" name="txtQuantity" value="${product.quantity}" /></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">Description:</th>
                                                            <td><textarea rows="" cols="" class="form-textarea" name="txtDescription" >${product.description}</textarea></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Image:</th>
                                                            <td><img height="200px" src="../images/${product.img}" /></br></td></tr><tr><td></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <input type="cancel" value="Cancel" class="form-reset"  />
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    </c:forEach>
